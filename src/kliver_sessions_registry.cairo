...
/// Error codes
pub mod Errors {
    pub const STEP_COMPLETED: felt252 = 'STEP_ALREADY_COMPLETED';
    pub const INVALID_POSITION: felt252 = 'INVALID_INTERACTION_POS';
    pub const PAUSED: felt252 = 'CONTRACT_PAUSED';
    pub const NOT_OWNER: felt252 = 'NOT_OWNER';
    pub const ZERO_ADDRESS: felt252 = 'ZERO_ADDRESS';
    pub const INVALID_SCORE: felt252 = 'INVALID_SCORE';
    pub const NO_INTERACTIONS: felt252 = 'NO_INTERACTIONS_FOUND';
    pub const INVALID_PAGINATION: felt252 = 'INVALID_PAGINATION';
    pub const SESSION_HAS_FAILED_STEP: felt252 = 'SESSION_HAS_FAILED_STEP';
}

/// Constants
pub mod Constants {
    pub const MAX_INTERACTIONS_PER_STEP: u32 = 15;
...
#[starknet::contract]
pub mod KliverSessionsRegistry {
