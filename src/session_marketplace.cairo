...
use crate::interfaces::session_marketplace::ISessionMarketplace;

use crate::interfaces::session_marketplace::{ListingStatus, SessionListing};
...
mod SessionMarketplace {
    ...
    #[abi(embed_v0)]
    impl SessionMarketplaceImpl of crate::interfaces::session_marketplace::ISessionMarketplace<ContractState> {
